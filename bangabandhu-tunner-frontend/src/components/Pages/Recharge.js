...
import { faCashRegister, faCheck, faCheckCircle, faCircleXmark, faXmarkCircle } from "@fortawesome/free-solid-svg-icons";
  ...
  return (
    <div className="mt-8 grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 place-content-center mx-auto w-full">
      ...
      <div className="w-96 mt-16">
        <div className="text-3xl font-bold w-full bg-[#F5F5F5] p-6 rounded flex">
          <h1 className="">Cash Payment</h1>
          <span className="ml-8">
        ...
        <label htmlFor="payment-success" className="btn modal-button mt-5">Successful modal</label>
          <input type="checkbox" id="payment-success" className="modal-toggle" />
          <div className="modal modal-bottom sm:modal-middle">
            <div className="modal-box">
              <div className="text-center">
              <FontAwesomeIcon className="text-5xl text-green-700 mb-4" icon={faCheckCircle}></FontAwesomeIcon>
        ...
        <label htmlFor="payment-fail-modal" className="btn modal-button mt-5 ml-5">fail modal</label>
          <input type="checkbox" id="payment-fail-modal" className="modal-toggle" />
          <div className="modal modal-bottom sm:modal-middle">
          <div className="modal-box">
              <div className="text-center">
              <FontAwesomeIcon className="text-5xl text-red-700 mb-4" icon={faCircleXmark}></FontAwesomeIcon>
              </div>
              <h3 className="font-bold text-lg text-center mb-5">Payment Failed!</h3>
              ...
              <div className="text-center mt-5">
                    <label htmlFor="payment-fail-modal" className="btn btn-sm bg-indigo-700 rounded text-white">
                    Try Again
                  </label>
              </div>
